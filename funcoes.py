...
for preco in lista_precos:
    total_imposto = calcula_imposto_total(preco)
    print(f"Imposto Total é R$ {preco} R$ {total_imposto}")
...
for preco in nova_lista_produtos:
    imposto_total = calcula_imposto_total(preco)
    print(f"Novo Imposto total sobre o produto de R${preco}: R${imposto_total}")
